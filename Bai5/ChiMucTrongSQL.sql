...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`Bai5_ChiMucTrongSQL` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `Bai5_ChiMucTrongSQL`;
...
call setCounter(@count,2);
call setCounter(@count,3);
select @count;
